...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $required_params = ['nama', 'no_hp', 'nik', 'laporan_pengaduan', 'uraian_laporan'];
    ...
    if ($koneksi->query($sql) === TRUE) {
        ...
        $response['message'] = "Berhasil memperbarui data korupsi";
        $updated_data_query = "SELECT * FROM tb_korupsi WHERE id = '$id'";
        ...
        $response['isSuccess'] = false;
        $response['message'] = "Gagal memperbarui data korupsi: " . $koneksi->error;
    }
} else {
    $response['isSuccess'] = false;
