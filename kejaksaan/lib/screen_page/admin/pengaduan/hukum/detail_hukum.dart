...
class DetailHukumAdmin extends StatelessWidget {
  final Datum data;
  const DetailHukumAdmin(this.data, {super.key});
      ...
      if (res.statusCode == 200) {
        ...
        if (data.isSuccess == true) {
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(builder: (context) => PageListHukumAdmin()),
              (route) => false);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: Text(
                      'Detail Pengaduan Penyuluhan Hukum',
                      style: TextStyle(
                        fontSize: 24,
