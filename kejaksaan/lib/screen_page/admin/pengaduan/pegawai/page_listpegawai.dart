...
import 'package:kejaksaan/screen_page/admin/pengaduan/pegawai/detail_pegawai.dart';
import 'package:kejaksaan/utils/ip.dart';
import 'package:shared_preferences/shared_preferences.dart';

class PageListPegawaiAdmin extends StatefulWidget {
  final Datum? data;
  const PageListPegawaiAdmin({this.data, super.key});

  @override
  State<PageListPegawaiAdmin> createState() => _PageListPegawaiAdminState();
}

class _PageListPegawaiAdminState extends State<PageListPegawaiAdmin> {
  bool isSearch = false;
  ...
  Future<void> getPegawai() async {
    try {
      ...
      final response = await http.get(Uri.parse(
          '$url/db_kejaksaan/listPengaduanAdmin.php?status=0&kategori=pegawai'));
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => DetailPegawaiAdmin(pegawai),
                            ),
                          );
                        },
                        child: Padding(
