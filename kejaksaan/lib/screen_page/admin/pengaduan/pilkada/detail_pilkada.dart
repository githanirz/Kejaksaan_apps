...
class DetailPilkadaAdmin extends StatelessWidget {
  final Datum data;
  const DetailPilkadaAdmin(this.data, {super.key});
      ...
      if (res.statusCode == 200) {
        ...
        if (data.isSuccess == true) {
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(builder: (context) => PageListPilkadaAdmin()),
              (route) => false);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: Text(
                      'Detail Pengaduan Posko Pilkada',
                      style: TextStyle(
                        fontSize: 24,
                  ...
                  FutureBuilder<String>(
                    future: _downloadFile('$url/berkas/${data.fotoKtp}'),
