...
class PageAgama extends StatefulWidget {
  const PageAgama({super.key});

  @override
  State<PageAgama> createState() => _PageAgamaState();
}

class _PageAgamaState extends State<PageAgama> {
