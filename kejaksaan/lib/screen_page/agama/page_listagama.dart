...
import 'package:kejaksaan/screen_page/agama/detail_agama.dart';
import 'package:kejaksaan/screen_page/agama/page_agama.dart';
import 'package:kejaksaan/screen_page/agama/update_agama.dart';

import 'package:kejaksaan/utils/ip.dart';
import 'package:shared_preferences/shared_preferences.dart';

class PageListAgama extends StatefulWidget {
  final Datum? data;
  const PageListAgama({this.data, super.key});

  @override
  State<PageListAgama> createState() => _PageListAgamaState();
}

class _PageListAgamaState extends State<PageListAgama> {
  bool isSearch = false;
  ...
  Future<void> getPegawai() async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse(
          '$url/db_kejaksaan/listPengaduan.php?id_user=$idUser&kategori=agama'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => PageAgama()));
        },
        tooltip: "tambah pengawasan",
        child: Icon(
          Icons.add,
          size: 25,
        ),
