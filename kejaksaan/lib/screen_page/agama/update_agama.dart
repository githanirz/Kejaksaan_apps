...
class UpdateAgama extends StatefulWidget {
  final Datum data;

  const UpdateAgama({Key? key, required this.data}) : super(key: key);

  @override
  _UpdateAgamaState createState() => _UpdateAgamaState();
}

class _UpdateAgamaState extends State<UpdateAgama> {
  File? _pdfFileKTP;
