...
class UpdateHukum extends StatefulWidget {
  ...
  const UpdateHukum({Key? key, required this.data}) : super(key: key);

  @override
  _UpdateHukumState createState() => _UpdateHukumState();
}
