...
import 'package:kejaksaan/model/modelCreateKorupsi.dart';
import 'package:kejaksaan/utils/ip.dart';
import 'package:shared_preferences/shared_preferences.dart';

class PageKorupsi extends StatefulWidget {
  const PageKorupsi({super.key});

  @override
  State<PageKorupsi> createState() => _PageKorupsiState();
}

class _PageKorupsiState extends State<PageKorupsi> {
    ...
    try {
      ...
      if (_pdfFileKTP != null && _pdfFileLaporan != null) {
        var request = http.MultipartRequest(
            'POST', Uri.parse('$url/db_kejaksaan/insertKorupsi.php'));
        ...
        request.fields['uraian_laporan'] = _uraianController.text;
        ...
        ModelCreateKorupsi data = modelCreateKorupsiFromJson(resBody.body);
