...
import 'package:kejaksaan/screen_page/korupsi/detail_korupsi.dart';
import 'package:kejaksaan/screen_page/korupsi/page_korupsi.dart';
import 'package:kejaksaan/screen_page/korupsi/update_korupsi.dart';
import 'package:kejaksaan/utils/ip.dart';
import 'package:shared_preferences/shared_preferences.dart';

class PageListKorupsi extends StatefulWidget {
  final Datum? data;
  const PageListKorupsi({this.data, super.key});
  ...
  Future<void> getKorupsi() async {
    ...
    try {
      ...
      final response = await http
          .get(Uri.parse('$url/db_kejaksaan/listKorupsi.php?id_user=$idUser'));
  ...
  Future<void> deletePengaduan(int id) async {
    ...
    try {
      ...
      http.Response res = await http.post(
          Uri.parse('$url/db_kejaksaan/deleteKorupsi.php'),
      ...
      if (res.statusCode == 200) {
        ...
        if (data.status == "success") {
          setState(() {
            korupsiList.removeWhere((pegawai) => pegawai.id == id.toString());
            ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => PageKorupsi()));
        },
        tooltip: "tambah korupsi",
        child: Icon(
          Icons.add,
          size: 25,
        ),
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  DetailKorupsi(pengaduan: korupsi),
                            ),
                          );
                        },
                        child: Padding(
